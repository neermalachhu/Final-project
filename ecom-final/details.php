...
$run_product = mysqli_query($con,"select manufacturer_id from products where product_url='$product_id'");
while($prd = mysqli_fetch_array ($run_product)){
$prod=$prd['manufacturer_id'];


$get_products = "select * from products where manufacturer_id=$prod";
